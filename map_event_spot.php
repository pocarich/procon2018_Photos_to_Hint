...
//削除時刻を過ぎたイベントスポットを削除
$result=$db->query("DELETE FROM map_event_spot WHERE delete_time < NOW()");
...
//指定地域のイベントスポットを取得して送信
echo $db->query("SELECT * FROM map_event_spot WHERE region_name='{$params["region_name"]}'");
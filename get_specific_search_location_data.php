...
//指定されたお題スポットの探索状況を取得して送信する
echo $db->query("SELECT * FROM search_location_info WHERE user_id='{$params["user_id"]}' AND region_name='{$params["region_name"]}' AND location_name='{$params["location_name"]}'");
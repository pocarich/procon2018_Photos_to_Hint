...
//指定されたお題スポットについてのコメントを取得して送信
$exist_data=$db->query("SELECT * FROM album_comment WHERE user_id='{$params["user_id"]}' AND region_name='{$params["region_name"]}' AND location_name='{$params["location_name"]}'");
echo $exist_data;
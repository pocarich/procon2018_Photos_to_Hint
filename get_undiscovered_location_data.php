...
//未発見お題スポット探索状況を取得して送信
echo $db->query("SELECT * FROM search_location_info WHERE user_id='{$params["user_id"]}' AND region_name='{$params["region_name"]}' AND state!='{$params["found_state"]}'");
